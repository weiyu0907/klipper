...
#elif CONFIG_MACH_STM32U585
    /* Clock already enabled in stm32_clock_init() via RCC_AHB2ENR1 bit14 */
#else
...
#if CONFIG_MACH_STM32F446 || CONFIG_MACH_STM32H7 || CONFIG_MACH_STM32F7 || CONFIG_MACH_STM32U585
